...
trait Linkable
{
	...
	public function link() {
		 return $this->belongsTo('App\Models\Storage\Sharing\Link');
	}
	...
	/**
	 * Check if this item has a link context.
	 *
	 ...
	 * @return App\Models\Storage\Sharing\Link
	 */
