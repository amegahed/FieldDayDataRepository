...
import NavBarView from '../../../../views/apps/search-viewer/header-bar/nav-bar/nav-bar-view.js';
import MenuBarView from '../../../../views/apps/search-viewer/header-bar/menu-bar/menu-bar-view.js';
