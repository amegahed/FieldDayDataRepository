...
import GeneralPrefsFormView from '../../../../../views/apps/search-viewer/forms/preferences/general-prefs-form-view.js';
import DisplayPrefsFormView from '../../../../../views/apps/search-viewer/forms/preferences/display-prefs-form-view.js';
import WindowPrefsFormView from '../../../../../views/apps/search-viewer/forms/preferences/window-prefs-form-view.js';
...
export default PreferencesGroupView.extend({
	...
	showRegion: function(name) {
		switch (name) {
			case 'item':
				this.showAppIcon('search_viewer');
				break;
			case 'general':
