...
import FirstButtonView from '../../../../../views/apps/audio-player/header-bar/track-bar/buttons/first-button-view.js';
import PrevButtonView from '../../../../../views/apps/audio-player/header-bar/track-bar/buttons/prev-button-view.js';
import NextButtonView from '../../../../../views/apps/audio-player/header-bar/track-bar/buttons/next-button-view.js';
import LastButtonView from '../../../../../views/apps/audio-player/header-bar/track-bar/buttons/last-button-view.js';
