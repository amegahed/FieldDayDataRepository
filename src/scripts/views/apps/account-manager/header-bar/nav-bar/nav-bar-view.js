...
import BackButtonView from '../../../../../views/apps/account-manager/header-bar/nav-bar/buttons/back-button-view.js';
import ForwardButtonView from '../../../../../views/apps/account-manager/header-bar/nav-bar/buttons/forward-button-view.js';
